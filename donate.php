            ...
            <div class="header">
                    ...
                    <div class="fixed-top">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-dark mx-background-top-linear">
                            <div class="container">
                                <a class="navbar-brand" rel="nofollow" target="_blank" href="http://scadonsak.com/7bF"
                                    style="text-transform: uppercase;"> Learn This Too...</a>
  ...
  <div class="donation_section">
     ...
     <form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
                    ...
                    <div class="txt_field">
                      ...
                      <div id="right">    
                        <div class="txt_field"> 
                    <input type="text"required id="emailid" name="emailid">
                    <span></span>
                    <label>Email</label>
                    </div>
                    </div>
                    <div id="right2">    
                        <div class="txt_field"> 
                    <input type="text"required id="contactno" name="contactno">
                    <span></span>
